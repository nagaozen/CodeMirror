...
(function() {
  ...
  CodeMirror.defineMIME("text/x-mssql", {
    name: "sql",
    keywords: set(sqlKeywords + "begin trigger proc view index for add constraint key primary foreign collate clustered nonclustered print return if end exec go"),
